---
description: "Resolve spec ambiguities before planning — asks up to 5 targeted questions that prevent downstream rework"
...
Also load `CONSTITUTION.md` from the project root for project constraints.
