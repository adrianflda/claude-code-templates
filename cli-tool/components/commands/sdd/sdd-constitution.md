---
description: "Create or update the project constitution — governing principles that all SDD artifacts must comply with"
...
- **Before /sdd-plan**: [what must be true about the spec]
- **Before /sdd-implement**: [what must be true about artifacts]
...
- No bracketed placeholder tokens remain (`[LIKE_THIS]` except in examples)
